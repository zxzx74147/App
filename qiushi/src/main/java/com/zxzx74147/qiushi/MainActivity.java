...
import com.zxzx74147.qiushi.modules.feed.FeedActivity;
import com.zxzx74147.qiushi.modules.feed.FeedInterface;
...
public class MainActivity extends AppCompatActivity
    ...
    public void onTestClick(View v) {
        ...
        tag.url = "http://119.29.47.97/article/list/text";
        tag.url = "http://119.29.47.97/article/list/imgrank";
        tag.url = "http://119.29.47.97/article/list/video";
        FeedInterface.startFeedActivity(this, tag);
    }
}
