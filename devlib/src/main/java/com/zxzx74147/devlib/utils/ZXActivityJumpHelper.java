...
public class ZXActivityJumpHelper {
    ...
    public static void startActivity(Context context, Class<? extends ZXBaseActivity> T, IntentData data) {
    ...
    public static void startActivity(Fragment fragment, Class<? extends ZXBaseActivity> T, IntentData data) {
    ...
    public static void startActivityForResult(Activity context, int requestCode, Class<? extends ZXBaseActivity> T, IntentData data) {
        Intent intent = new Intent(context, T);
        intent.putExtra(INTENT_DATA, data);
